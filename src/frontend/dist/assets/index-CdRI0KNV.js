...
const University = createLucideIcon("university", __iconNode$1);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 md:px-8 py-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8 mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-lg text-foreground mb-2", children: "Gyan Prakash Chaurasiya" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mb-4", children: "BCA (Hons.) Student · Web Developer · Digital Marketing Learner" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-sm uppercase tracking-wider text-muted-foreground mb-3", children: "Quick Links" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-1", children: ["#about", "#skills", "#projects", "#contact"].map((href) => {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-sm uppercase tracking-wider text-muted-foreground mb-3", children: "Contact" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: "Gyanpc1656@gmail.com" })
                  ]
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2 text-sm text-muted-foreground", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Indrapuri, Loni, Ghaziabad, UP" })
              ] })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
          "© ",
          year,
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-smooth ${isScrolled ? "bg-card/95 backdrop-blur-md border-b border-border shadow-nav" : "bg-card/80 backdrop-blur-sm border-b border-border/50"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 md:px-8 h-16 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg gradient-primary flex items-center justify-center shadow-elevated", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CodeXml, { className: "w-4 h-4 text-primary-foreground" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-foreground group-hover:text-primary transition-smooth text-base tracking-tight", children: "Gyan Prakash" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              children: NAV_LINKS.map((link) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
                  {
                    ...
                    className: `px-3 py-1.5 rounded-md text-sm font-medium transition-smooth relative ${isActive ? "text-primary bg-primary/10" : "text-muted-foreground hover:text-foreground hover:bg-muted/60"}`,
                    "aria-current": isActive ? "page" : void 0,
                    children: [
                      link.label,
                      isActive && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-0 left-1/2 -translate-x-1/2 w-1 h-1 rounded-full bg-primary" })
                    ]
                  },
                  link.href
                );
        ...
        isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "container mx-auto px-4 py-3 flex flex-col gap-0.5", children: NAV_LINKS.map((link) => {
              const isActive = activeSection === link.href.slice(1);
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  ...
                  className: `px-4 py-2.5 rounded-md text-sm font-medium transition-smooth ${isActive ? "text-primary bg-primary/10 font-semibold" : "text-muted-foreground hover:text-foreground hover:bg-muted/60"}`,
                  children: link.label
                },
                link.href
              );
...
function AboutSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 md:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center lg:justify-start", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-64 h-64 rounded-2xl bg-card card-elevated card-accent-bar overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-primary rounded-full" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-semibold text-sm uppercase tracking-wider", children: "About Me" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading mb-4", children: "Motivated Developer & Lifelong Learner" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-6 text-base", children: "I am a motivated BCA (Hons.) student currently pursuing my degree from Dev Sanskriti Vishwavidyalaya. I have foundational knowledge in programming languages such as Python, C, and JavaScript, along with skills in HTML, CSS, SQL, and Digital Marketing. I completed a 2-month internship at Assetplus Consulting, where I gained practical experience in office and digital tasks. I am passionate about learning new technologies and building real-world projects to enhance my technical skills." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", "data-ocid": "about.highlights_list", children: highlights.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "li",
            {
...
function CertCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": `certificates.item.${index2 + 1}`,
      children: [
        cert.isPdf ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden bg-muted/50 aspect-video flex flex-col items-center justify-center gap-3 border-b border-border/40", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-2xl bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-7 h-7 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-medium", children: "PDF Certificate" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: cert.image,
              ...
              "data-ocid": `certificates.view_pdf.${index2 + 1}`,
              children: [
          ...
          expanded && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-card p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "object",
            {
              data: cert.image,
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground text-center py-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              "aria-label": expanded ? "Collapse PDF preview" : "Preview PDF inline",
              "data-ocid": `certificates.image_toggle.${index2 + 1}`,
              children: expanded ? "Collapse" : "Preview PDF"
            }
          )
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            onClick: () => setExpanded((v) => !v),
            "aria-label": expanded ? "Collapse certificate image" : "Expand certificate image",
            "data-ocid": `certificates.image_toggle.${index2 + 1}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: cert.image,
                  alt: cert.title,
                  className: `w-full object-cover transition-all duration-500 group-hover:scale-105 ${expanded ? "aspect-auto max-h-96" : "aspect-video"}`
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-foreground/0 group-hover:bg-foreground/5 transition-colors duration-200" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-2 right-2 text-[10px] text-primary-foreground bg-primary/80 px-2 py-0.5 rounded-full font-medium backdrop-blur-sm", children: expanded ? "Click to collapse" : "Click to expand" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 flex flex-col gap-3 flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
                ...
                children: [
                  cert.badgeVariant === "gold" && /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { className: "w-3 h-3" }),
                  cert.badgeVariant === "silver" && /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { className: "w-3 h-3" }),
                  cert.badge
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs text-muted-foreground", children: cert.category })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-lg leading-snug mb-1", children: cert.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary text-sm font-medium leading-snug", children: cert.event })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5 text-sm text-muted-foreground mt-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(University, { className: "w-3.5 h-3.5 text-primary shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: cert.institution })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground border-t border-border/60 pt-3 mt-1", children: [
            "Signed by:",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: cert.signedBy })
          ] })
        ] })
      ]
    }
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 md:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-primary rounded-full" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-semibold text-sm uppercase tracking-wider", children: "Recognition" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-primary rounded-full" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading mb-3", children: "Certificates & Achievements" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto text-base", children: "Recognized for web design, infographics, hackathon performance, and internship completion across national conferences, competitions, and organizations." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: certificates.map((cert, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(CertCard, { cert, index: i }, cert.event))
          }
        )
      ] })
    }
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 md:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-primary rounded-full" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-semibold text-sm uppercase tracking-wider", children: "Contact" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-primary rounded-full" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading", children: "Get In Touch" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subheading", children: "Have an opportunity? I'd love to hear from you." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-10 max-w-5xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-lg mb-6", children: "Contact Details" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4 mb-8", "data-ocid": "contact.info_list", children: contactInfo.map((item, i) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-lg gradient-primary flex items-center justify-center shrink-0 shadow-elevated", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-5 h-5 text-primary-foreground" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground uppercase tracking-wider font-semibold mb-0.5", children: item.label }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary/5 border border-primary/15 rounded-xl p-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground font-medium mb-1", children: "Open to opportunities" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "I'm actively looking for internships and entry-level positions in web development and digital marketing." })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
              ...
              children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-lg", children: "Message Sent!" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Your mail client should open with the pre-filled message." })
                  ]
                }
              ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "form",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "subject", className: "text-sm font-medium", children: "Subject" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Input,
                        {
                          id: "subject",
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 md:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-primary rounded-full" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-semibold text-sm uppercase tracking-wider", children: "Education" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-primary rounded-full" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading", children: "Academic Background" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subheading", children: "My educational journey" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-3xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", "data-ocid": "education.timeline", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: education.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "relative flex gap-6",
              "data-ocid": `education.item.${i + 1}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 flex-shrink-0 mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: `w-12 h-12 rounded-full flex items-center justify-center border-2 ${item.status === "current" ? "border-primary bg-primary text-primary-foreground shadow-elevated" : "border-border bg-card text-muted-foreground"}`,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    className: `flex-1 bg-card rounded-xl p-5 border card-accent-bar shadow-xs hover:shadow-elevated transition-smooth ${item.status === "current" ? "border-primary/30" : "border-border"}`,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-base", children: item.degree }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-0.5", children: item.institution })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
                          item.grade && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 text-sm font-semibold text-primary bg-primary/10 px-2.5 py-1 rounded-full border border-primary/20", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { className: "w-3 h-3" }),
                            item.grade
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-xs text-muted-foreground mt-1.5 justify-end", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "w-3 h-3" }),
                            item.year
                          ] })
                        ] })
                      ] }),
                      item.status === "current" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block mt-2 text-xs font-medium text-primary bg-primary/10 px-2 py-0.5 rounded-full", children: "● Active" })
                    ]
                  }
                )
              ]
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 md:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-primary rounded-full" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-semibold text-sm uppercase tracking-wider", children: "Experience" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-primary rounded-full" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading", children: "Work Experience" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subheading", children: "Professional background and internship" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl mx-auto", "data-ocid": "experience.list", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "bg-card card-elevated card-accent-bar rounded-2xl p-6 md:p-8",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-4 mb-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl gradient-primary flex items-center justify-center shadow-elevated shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "w-6 h-6 text-primary-foreground" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-xl", children: "Intern" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary font-semibold text-base", children: "Assetplus Consulting" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-muted-foreground bg-muted/60 px-3 py-1.5 rounded-full border border-border", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "w-4 h-4 text-primary" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "2 Months" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/40 rounded-xl p-4 border border-border/50", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-wider font-semibold text-muted-foreground mb-3", children: "Responsibilities" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: tasks.map((task, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "li",
                  {
                    className: "flex items-start gap-2.5 text-sm text-foreground",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs font-medium text-primary bg-primary/10 px-3 py-1 rounded-full border border-primary/20", children: "Office Operations" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs font-medium text-primary bg-primary/10 px-3 py-1 rounded-full border border-primary/20", children: "Digital Tasks" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs font-medium text-primary bg-primary/10 px-3 py-1 rounded-full border border-primary/20", children: "Data Handling" })
              ] })
            ]
          }
        ) })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 md:px-8 py-16 relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-slide-up", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
                    ...
                    children: "Open to Internships & Fresher Roles"
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl sm:text-5xl xl:text-6xl font-bold text-foreground leading-tight mb-4", children: [
                "Hi, I'm ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Gyan Prakash" }),
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-medium text-3xl sm:text-4xl xl:text-5xl block mt-1", children: "Chaurasiya" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground font-medium mb-2", children: "BCA (Hons.) Student · Web Developer · Digital Marketing Learner" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3", "data-ocid": "home.cta_buttons", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    size: "lg",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    ...
                    children: [
                      "View Projects",
                      /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDown, { className: "w-4 h-4 ml-2" })
                    ]
                  }
                )
              ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center lg:justify-end animate-fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-md", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -bottom-4 -left-4 bg-card border border-border rounded-xl px-4 py-3 shadow-elevated animate-scale-in", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Projects Completed" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-display font-bold text-primary", children: "4+" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -top-4 -right-4 bg-card border border-border rounded-xl px-4 py-3 shadow-elevated animate-scale-in", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Internship" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-display font-bold text-primary", children: "4 mo" })
              ] })
            ] }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mt-16 animate-fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              onClick: () => {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-widest font-medium", children: "Scroll down" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDown, { className: "w-4 h-4 group-hover:translate-y-1 transition-smooth" })
              ]
            }
          ) })
        ] })
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 md:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-primary rounded-full" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-semibold text-sm uppercase tracking-wider", children: "Personal" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-primary rounded-full" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading", children: "Hobbies & Languages" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subheading", children: "Beyond the screen — what drives me" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-4xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", "data-ocid": "hobbies.list", children: hobbies.map((hobby, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl", children: hobby.emoji }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground", children: hobby.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: hobby.description })
                  ] })
                ]
              },
              hobby.name
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", "data-ocid": "hobbies.languages_list", children: languages.map((lang, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl", children: lang.flag }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground", children: lang.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: lang.level })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-primary bg-primary/10 px-2.5 py-1 rounded-full border border-primary/20", children: lang.level })
                ]
              },
              lang.name
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 bg-primary/5 border border-primary/15 rounded-xl p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-primary", children: "Fun fact:" }),
              " ",
              "I'm currently learning Lithuanian as part of my love for exploring new cultures and languages! 🇱🇹"
            ] }) })
          ] })
        ] })
      ] })
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 md:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-primary rounded-full" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-semibold text-sm uppercase tracking-wider", children: "Projects" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-primary rounded-full" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading", children: "My Work" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subheading", children: "Projects I've built and deployed" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: projects.map((project, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "article",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl gradient-primary flex items-center justify-center mb-4 shadow-elevated", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Code, { className: "w-5 h-5 text-primary-foreground" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-lg mb-3 group-hover:text-primary transition-smooth leading-snug", children: project.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1 mb-4 flex-1", children: project.description.map((desc) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "li",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 mb-5", children: project.technologies.map((tech) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Badge,
                    {
                      variant: "secondary",
                    ...
                    Button,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "a",
                        {
                          ...
                          children: [
                            "View Project",
                            /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "w-3.5 h-3.5 ml-1.5" })
                          ]
                        }
                      )
                    }
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 md:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-primary rounded-full" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-semibold text-sm uppercase tracking-wider", children: "Skills" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-primary rounded-full" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading", children: "Technical Expertise" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subheading", children: "Tools and technologies I work with" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-display font-bold text-foreground mb-5 flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-6 h-6 rounded-md gradient-primary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-primary-foreground", children: "T" }) }),
                  "Technical Skills"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", "data-ocid": "skills.technical_list", children: technicalSkills.map((skill, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "skills.learning_list", children: learningSkills.map((skill, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-foreground", children: skill }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-xs text-primary bg-primary/10 px-2 py-0.5 rounded-full font-medium", children: "Learning" })
                      ]
                    },
                    skill
                  )) })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground mb-4", children: "Quick Overview" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: technicalSkills.map((skill, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(HobbiesSection, {}),
